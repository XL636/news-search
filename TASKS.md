...
| 101 | AI 模型升级 GLM-5 + GLM-4.6V | 2026-02-25 | 文本 glm-4-plus→glm-5，视觉 glm-4.6v-flash→glm-4.6v |
| 102 | AI 后端切换到通义千问 | 2026-02-25 | GLM→Qwen，文本 qwen-plus，视觉 qwen-vl-plus，DashScope API |
| 103 | 图片搜索交互改造 | 2026-02-25 | 取消自动搜索，支持图片+文本同时发送，后端组合搜索 |
| 104 | 浅色主题改造 (Claude 暖米色风格) | 2026-02-25 | CSS 变量/硬编码颜色/Tailwind 类/JS 常量全面替换为浅色主题 |
